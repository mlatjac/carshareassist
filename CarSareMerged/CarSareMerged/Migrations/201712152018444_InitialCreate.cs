namespace CarSareMerged.Migrations
{
    ...
    public partial class InitialCreate : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                c => new
                    {
                        ID = c.Int(nullable: false, identity: true),
                        MemberId = c.Byte(nullable: false),
                ...
                .ForeignKey("dbo.Members", t => t.UserMember_ID)
                .Index(t => t.Car_ID)
                .Index(t => t.UserMember_ID);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Loans", "UserMember_ID", "dbo.Members");
            ...
            DropIndex("dbo.Loans", new[] { "UserMember_ID" });
